                                    ...
                                    <div class="col-md-2">
                                        <strong>Montant Total:</strong><br>
                                            <span class=" badge bg-warning">
                                                <h4>{{ number_format($statistiques['montant_total'], 0, ',', ' ')}} CFA
                                                    </h4>
                                            </span>
                                    </div>
                                    <div class="col-md-2">
                                        <strong>Montant Payé:</strong><br>
                                         <span class=" badge bg-success">
                                            <h4>{{ number_format($statistiques['montant_paye'], 0, ',', ' ') }} CFA</h4></span>
                                    </div>
                                     <div class="col-md-2">
                                        <strong>Montant Retour:</strong><br>
                                        <span class=" badge bg-danger">
                                            <h4> {{ number_format($factures->sum('montant_retour'), 0, ',', ' ')    }} CFA
                                                </h4></span>
                                    </div>
                                    <div class="col-md-3">
                                        <strong>Reste à payer :</strong><br>
                                        <span class=" badge bg-info">
                                            <h4>{{ number_format($factures->sum('montant_restant') - $factures->sum('montant_retour'), 0, ',', ' ') }} CFA </h4>
                                        </span>
                                    </div>
                                </div>
                            </div>
